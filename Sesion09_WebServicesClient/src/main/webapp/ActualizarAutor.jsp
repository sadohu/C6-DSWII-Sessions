	...
	<table border="2" align="center">
		...
		<input type="hidden" name="idautor" value="<%=autor.getIdautor()%>">
			<tr>
				...
				<td><input type="text" name="nomautor" value="<%=autor.getNomautor()%>"></td>
			</tr>
			
			<tr>
				<td>Descripcion</td>
				<td><input type="text" name="descrip" value="<%=autor.getDescrip()%>"></td>
			</tr>
			
			<tr>
				<td colspan="2" align="center"><input type="submit"
					class="btn btn-primary" value="Actualizar Autor"></td>
			</tr>
		</form>
	</table>
</body>